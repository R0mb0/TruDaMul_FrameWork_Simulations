[![Codacy Badge](https://app.codacy.com/project/badge/Grade/fccf547717934fdb898fa0e5a17f93b8)](https://app.codacy.com/gh/R0mb0/TruDaMul_FrameWork_Simulations/dashboard?utm_source=gh&utm_medium=referral&utm_content=&utm_campaign=Badge_grade)
[![pages-build-deployment](https://github.com/R0mb0/TruDaMul_FrameWork_Simulations/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/R0mb0/TruDaMul_FrameWork_Simulations/actions/workflows/pages/pages-build-deployment)
...
5. Before (or while) announcing the tender, M1 also uploads the payload pC to the DFS.
...
8. P can finally decrypt the payload pC (previously obtained from the DFS) and send the message.  
